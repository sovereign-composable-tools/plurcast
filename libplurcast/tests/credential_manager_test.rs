...
fn test_credential_manager_basic_operations() {
    ...
    // Test store
    manager.store("plurcast.test", "test_key", "test_value").unwrap();
...
fn test_credential_manager_encrypted_storage() {
    ...
    // Test store
    manager.store("plurcast.test", "encrypted_key", "secret_value").unwrap();
...
fn test_credential_manager_fallback_logic() {
    ...
    manager.store("plurcast.test", "fallback_key", "fallback_value").unwrap();
